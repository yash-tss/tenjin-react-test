...
import sty from "./PlasmicButton.module.css"; // plasmic-import: VioHJSVZJRHK/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: ypFp-QTScmv_/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: tEOdVAoEtxuX/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__gQdHu)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__w4MF6)}
                role={"img"}
              />
            ),
